...
- use `python3 scripts/voice_digest_openclaw_notifier.py --check-setup --json` when you want a direct readiness answer about payload/handoff/delivery-target/config/CLI wiring only
